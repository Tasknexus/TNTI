...
// Array holding the service details: icon, title, and description.
const services = [
  {
  ...
  return (
    <Box sx={{ py: 10, backgroundColor: 'background.paper' }}>
      <Container maxWidth="xl">
        ...
        {/* Grid Layout to Display Service Cards */}
        <Grid container spacing={4} justifyContent="center">
          {services.map((service, index) => (
            ...
            >
              <Card sx={{ 
                width: '100%',
                maxWidth: 350,  // Fixed maximum width for card
                ...
                '&:hover': {
                  ...
                  boxShadow: '0 15px 35px rgba(0, 0, 0, 0.1)' // Hover effect to lift card and increase shadow
                }
              }}>
                {/* Card Content */}
                <CardContent sx={{ 
